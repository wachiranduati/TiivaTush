...
if($page == 1){
    $query = "SELECT * FROM `products` WHERE `category`='".mysql_real_escape_string($search)."' AND `availability`='1' AND `buyer`='0' LIMIT $items1";
}else{
    $query = "SELECT * FROM `products` WHERE `category`='".mysql_real_escape_string($search)."' AND `availability`='1' AND `buyer`='0' LIMIT $items OFFSET $jump";
}
...
$query2 = "SELECT * FROM `products` WHERE `category`='".mysql_real_escape_string($search)."' AND `availability`='1' AND `buyer`='0' ORDER BY RAND()";
