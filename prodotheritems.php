...
echo 
    "
    <div class=\"col-lg-3 col-md-3 col-sm-3 col-xs-3\" id=\"box1\">
    <div class=\"row\" style=\"padding:4px;\">
            ...
            <div class=\"col-lg-1 col-md-1 col-sm-1 col-xs-1\"></div>
                <div class=\"col-lg-10 col-md-10 col-sm-10 col-xs-10\">
                    <a href=\"productdetails.php\" class=\"btn btn-block btn-primary\" data-name=\"$query_row[itemtitle]\" data-price=\"$query_row[price]\">Add to Cart</a>
                </div>
                <div class=\"col-lg-1 col-md-1 col-sm-1 col-xs-1\"></div>
            </div>
        </div>
