...
<head>
    ...
    <body onload=\"boxed();wishlistcount();showwishlistitems();updateview();\">
    ...
    <!-- end of advanced search container -->
           ...
           <!-- <div class=\"row\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                    ...
                    <strong>Booked!</strong> <span class=\"text-uppercase\"><<<< $query_row[itemtitle] </span>has been hidden from other users>>>>>
                    ...
                    <div id=\"imagecarousel\" class=\"carousel slide\" data-interval=\"3000\" data-ride=\"carousel\">
                        <div class=\"carousel-inner\">
                            ...
                            <div class=\"item active\">
                                    <img src=\"uploadproducts/$query_row[imageone]\" class=\"img-responsive productslideimages\">
                            ...
                            <div class=\"item\">
                                    <img src=\"uploadproducts/$query_row[imagetwo]\" class=\"img-responsive productslideimages\">
                                    <div class=\"carousel-caption\">
                                        <h3>Image two</h3>
                            ...
                            <div class=\"item\">
                                    <img src=\"uploadproducts/$query_row[imagethree]\" class=\"img-responsive productslideimages\">
                                    <div class=\"carousel-caption\">
                                        <h3>Image three</h3>
                            ...
                            <div id=\"modalimagecontainer\">
                                <img id=\"myImg\" src=\"uploadproducts/$query_row[imageone]\" alt=\"$query_row[itemtitle] $description\" class=\"modpic img-responsive\">
                                ...
                                <img id=\"myImg2\" src=\"uploadproducts/$query_row[imagetwo]\" alt=\"$query_row[itemtitle] $description\" class=\"modpic img-responsive\">
                                <span class=\"glass glyphicon glyphicon-search\"></span>
                                ...
                                <img id=\"myImg3\" src=\"uploadproducts/$query_row[imagethree]\" alt=\"$query_row[itemtitle] $description\" class=\"modpic img-responsive\">
                                <span class=\"glass glyphicon glyphicon-search\"></span>
                            ...
                            <div class=\"row visible-lg visible-md\">
                                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                    <div class=\"row\">
                                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                    <span>Share <small><strong>$query_row[itemtitle]</strong></small> on <a href=\"facebook.com\">facebook</a> <a href=\"twitter.com\">twitter</a> <a href=\"instagram\">Instagram</a></span>
                                </div>
                            </div>
                                </div>
                            </div>
                            <div class=\"row visible-lg visible-md\">
                                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"background-color:#EEEEEE;\">
                            ...
                            <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                <div class=\"row\">
                                    ...
                                    <!--item title container-->
                                        <div class=\"row visible-lg visible-md\">
                                            <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                                <h4 class=\"text-uppercase text-center\" style=\"font-family:kok;color:black;\"><strong>$query_row[itemtitle]</strong></h4>
                                        ...
                                        <div class=\"row\">
                                            <div class=\"col-lg-6 col-md-6 col-sm-6 col-xs-6\">
                                                <a class=\"btn btn-block btn-primary btn-lg\" onclick=\"addnewitem();\">Add to cart</a>
                                            </div>
                                            <div class=\"col-lg-6 col-md-6 col-sm-6 col-xs-6\">
                                                <a class=\"btn btn-block btn-danger btn-lg\" onclick=\"removenewitem();\"><small>Remove from cart</small></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class=\"row\">
                                            <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                            Share item on <a href=\"facebook.com\">Facebook</a> <a href=\"twitter.com\">Twitter</a> <a href=\"instagram.com\">instagram</a> <a href=\"youtube.com\">youtube</a>
                                            </div>
                                        </div>
                                ...
                                <div class=\"col-lg-10 col-md-10 col-sm-12 col-xs-12\" style=\"background-color:#EEEEEE;\">
                                    ...
                                    <div class=\"col-lg-5 col-md-5 col-sm-12 col-xs-12\">
                                        ...
                                        <div class=\"row\">
                                            <div class=\"col-lg-1 col-md-1 col-sm-1 col-xs-1\"></div>
                                            <div class=\"col-lg-10 col-md-10 col-sm-9 col-xs-9\" style=\"border:1px solid rgb(0, 186, 255);\">
                                                <div class=\"row\">
                                                ...
                                                <div class=\"row\" style=\"margin-top:2%;\">
                                                    <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                                        ...
                                                        <p><span class=\"glyphicon glyphicon-refresh\" style=\"color:rgba(0, 98, 255, 0.86);\"></span> 3 days return policy</p>
                ...
                <div class=\"col-lg-11 col-md-11 col-sm-11 col-xs-11\">
                                            <div class=\"tabbable\">
                                                <ul class=\"nav nav-tabs\">
                                                    ...
                                                    <li><a href=\"#tab2\" data-toggle=\"tab\">Reviews &#38  Comments</a></li>
                                                </ul>
                                                <div class=\"tab-content\">
                                                    <div class=\"tab-pane active\" id=\"tab1\">
                                                    <p style=\"margin-top:2%;\" class=\"visible-lg visible-md\"></p>
                                                    <p>$description</p>
                                                    </div>
                                                    <div class=\"tab-pane\" id=\"tab2\">
                                                    <p style=\"margin-top:2%;\" class=\"visible-lg visible-md\"></p>
                                                        <p id=\"itemreview\" class=\"text-center\">No reviews yet</p>
                                                    </div>
...
while($query_row = mysql_fetch_assoc($query_run)){
    ...
    echo "
<div class=\"col-lg-3 col-md-3 col-sm-6 col-xs-6\" id=\"box2\">
<a href=\"storeproduct.php?id=$query_row[id]\" target=\"_blank\" style=\"text-decoration:none;\">

        <div class=\"row\" style=\"padding:4px;\">
                    <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 productimage2\" style=\"background-image:url('uploadproducts/compressedproducts/$query_row[imageone]'); height:140px;width:100%;background-size:75%;\">
                ...
                <p class=\"text-capitalize\" style=\"margin:0px;padding:0px;font-family:kok;\">
                    $query_row[label]<span class=\"pull-right\">Tiiva Shop</span>
                </p>
                ...
                <h1 class=\"text-center text-capitalize\" style=\"font-family:kok;padding:0px;margin:0px;color:#606060;font-size:100%;text-decoration:none;\">
                    <strong>$query_row[itemtitle]</strong>
                </h1>
        ...
        <script>
           ...
           xmlhttp05.onreadystatechange = function(){
                if (xmlhttp05.readyState == 4 && xmlhttp05.status == 200){
                    ...
                    xmlhttp05.open('GET','stolencart.php?action=add&id=$id&site=shop',true);
                    xmlhttp05.send();
            }
           ...
           xmlhttp06.onreadystatechange = function(){
                if (xmlhttp06.readyState == 4 && xmlhttp06.status == 200){
                    ...
                    xmlhttp06.open('GET','stolencart.php?action=remove&id=$id&site=shop',true);
                    xmlhttp06.send();
            }
