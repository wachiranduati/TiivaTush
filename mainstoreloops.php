...
//store control for the store main page
...
if(isset($_GET['category'])){
    ...
    if(!empty($category)){
        ...
        if($query_num_rows <= $notifymecount){
            ...
            if(file_exists('logs/Queried_searches.txt')){
                ...
                <div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-6\" id=\"box1\">
                        <div class=\"row\" style=\"padding:4px;\">
                                <a href=\"storeproduct.php?id=$query2_row[id]\" target=\"_blank\"><div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 productimage\" style=\"background-image:url('mtumbauploads/compresseduploads/$query2_row[imageone]'); height:140px;width:100%;background-size:75%;\">
            ...
            <div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-6\" id=\"box1\">
                    <div class=\"row\" style=\"padding:4px;\">
                                <a href=\"storeproduct.php?id=$query2_row[id]\" target=\"_blank\">
                                    <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 productimage\" style=\"background-image:url('uploadproducts/compressedproducts/$query2_row[imageone]'); height:140px;width:100%;background-size:75%;\">
                                       <img src=\"images/newitemstag.png\" class=\"img-responsive visible-lg visible-md mtushtags\" style=\"height:40%;position:absolute;top:-1.5%;left:75%;\"/>
