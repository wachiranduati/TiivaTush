...
$query = "SELECT * FROM `products` WHERE `category`!='kids' AND `category`!='interiors' AND `sex`!='female' AND `availability`='1' AND `buyer`='0'";
...
$query2 = "SELECT * FROM `products` WHERE `category`!='kids' AND `category`!='interiors' AND `sex`!='female' AND `availability`='1' AND `buyer`='0' ORDER BY RAND() LIMIT 6";
