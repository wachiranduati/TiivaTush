...
if($dbs == 'products'){
    ...
    $query2 = "SELECT * FROM $dbs WHERE `instock`>='1' AND `itemtitle` LIKE '%".mysqli_real_escape_string($conn, $search)."%'";
}else{
    $query2 = "SELECT * FROM $dbs WHERE `instock`>='1' AND `itemtitle` LIKE '%".mysqli_real_escape_string($conn, $search)."%'";
}
...
echo "
        <!doctype html>
<html>
    <title>Tiiva.co.ke | $title | Search results for \" $search\" | $sub</title>
    <head>
...
<!-- end of advanced search container -->
            ...
            <div class=\"row\" style=\"font-family:kok;\">
                ...
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                    <div class=\"row\">
                        <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:#00baff;margin-bottom:5px;\"><h5 class=\"text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">$title | <small style=\"color:white;\" class=\"lowercase\">Search results for \"$search\"</small> </a></h5></div>
                    </div>
                ...
                <div class=\"col-lg-8 col-md-8 col-sm-12 col-xs-12\">
                    <div class=\"row\">
                    <div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-4 mainpagelinks\"><a href=\"index.php\" style=\"text-decoration:none;\"><h3 style=\"padding:0px;margin:0px;\">Shack</h3></a></div>
            ...
            <div class=\"row visible-sm visible-xs\" style=\"margin-top:5px;\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:2px solid orange;\">
                    <div class=\"row\">
                        <div class=\"col-lg-2 col-md-2 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:black;margin-bottom:5px;\"><h4 class=\"text-center text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">$title | <small style=\"color:white;\" class=\"lowercase\">Search results for \"$search\"</small></a></h4></div>
                    </div>
