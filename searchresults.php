...
if($dbs == 'products'){
    $query2 = "SELECT COUNT(*) FROM $dbs WHERE `availability`='1' AND `buyer`='0' AND `itemtitle` LIKE '%".mysqli_real_escape_string($conn, $search)."%'";
        ...
        echo pageTitle('search results');
            ...
            <div class="row visible-sm visible-xs" style="margin-top:5px;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-bottom:2px solid orange;">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="border-bottom:1px solid white;background-color:black;margin-bottom:5px;"><h4 class="text-center text-uppercase" style="font-weight:bold;color:white;"><a href="item.html" style="color:white;" class="btn-block"><?php echo $title;?> | <small style="color:white;" class="lowercase">Search results for <?php echo "$search";?></small></a></h4></div>
                    </div>
