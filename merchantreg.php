...
<!--                    first create a header saluting said customer and explaining what teh page does plus a link to contact us-->
                    ...
                    <div class="row" style="background-image:url(images/misc/milos-simic-351441.png);background-size:110%;background-position:center;background-attachment:fixed;background-repeat: no-repeat;">
