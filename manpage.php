...
echo "
        <!doctype html>
<html>
    <title>Tiiva.co.ke | Mtumba | $search | $gender</title>
    <head>
...
<!--                                   SIMPLE SEARCH START-->
                     ...
                     <div class=\"row\" id=\"simplesearch\" style=\"display:block;visibility:visible;padding:0;\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
...
<!-- start of advanced search container -->
    ...
    <!-- end of advanced search container -->
            ...
            <div class=\"row\" style=\"font-family:kok;\">
                ...
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                    <div class=\"row\">
                        <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:#00baff;margin-bottom:5px;\"><h5 class=\"text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">Mtumba | $search | $gender</a></h5></div>
                    </div>

                    <div class=\"row hidden\">
                        <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:#00baff;margin-bottom:5px;\"><h4 class=\"text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">Mtumba | $search | $gender</a></h4></div>
                    </div>
            ...
            <div class=\"row visible-sm visible-xs\" style=\"margin-top:5px;\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:2px solid orange;\">
                    <div class=\"row\">
                        <div class=\"col-lg-2 col-md-2 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:black;margin-bottom:5px;\"><h4 class=\"text-center text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">$search | $gender</a></h4></div>
                    </div>
...
while($loopscount <= $pagecount){
        ...
        if($loopscount == $page){
            echo "<li class=\"active\"><a href=\"manpage.php?search=$search&sub=$sub&page=$loopscount\">$loopscount</a></li>";
        }else{
            echo "<li><a href=\"manpage.php?search=$search&sub=$sub&page=$loopscount\">$loopscount</a></li>";
        }
    $loopscount++;
