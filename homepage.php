    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visible-lg visible-md" style="background-image:url(editions/pexels-photo-247304.jpeg);background-size:100%;background-position:center;">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:2%;font-family:kok;padding-bottom:0.6%;">
                        <div class="row">
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-position:center;background-repeat:no-repeat;font-family:kok;">
                                <div class="row" style="background-color:rgba(0, 0, 0, 0.49);font-family:kok;color:white;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <h4 class="text-center text-capitalize" style="color:orange;font-family:kok;border:1px solid gainsboro;border-bottom:none;border-top:none;">Be it from</h4><br>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:1%;padding:1%;">
                                                ...
                                                <p class="text-center" style="border:1px solid gainsboro;border-top:none;font-family:kok;padding:1%;border-bottom:none;"><em>"We got you sorted...."</em></p>
                                                <p>We felt the need to build different sections and so we came up with ...</p><ul><li><a href="shop.php">The shop</a> - Resembles any other ecommerce site</li><li><a href="index.php">The shack</a> - this primary deals in mtumba</li></ul><br><p class="text-capitalize text-center">all under one roof</p>
