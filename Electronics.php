...
<!DOCTYPE html>
<html>
<title>Tiiva | Electronics &amp; Computers</title>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 " style="border-top:1px solid gainsboro;">
                    ...
                    <div class="row visible-lg visible-md" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h2 class="text-center text-uppercase" style="margin-top:10px; color:orange;">Electronics &amp; Computers</h2></div>
                    </div>

                    <div class="row visible-sm visible-xs" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h4 class="text-center text-uppercase" style="margin-top:-1px; color:orange;">Electronics &amp; Computers</h4></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Phones &amp; Accessories</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;TV, Video &amp; Audio</a>
                            ...
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsclutchwristletbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Videogames</a>
                            ...
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="icons/boxicon.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Computers &amp; Tablets</a>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 visible-md visible-lg">
                        ...
                        <ul id="categories" style="line-height:2.5;padding-bottom:0;margin-bottom:2px;">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Phones &amp; Accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;TV, Video &amp; Audio<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsclutchwristletbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Videogames<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagstravelathleticbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Computers &amp; Tablets<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsmiscpencilcase.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Camera &amp; Photo<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:1px solid gainsboro;">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Phones &amp; Accessories</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">TV, Video &amp; Audio</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Computers &amp; Tablets</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Camera &amp; Photo</p></a></div>
                    </div>
                    ...
                    <div class="row visible-sm visible-xs" style="padding:7px;">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Phones &amp; Accessories</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">TV, Video &amp; Audio</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Computers &amp; Tablets</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Camera &amp; Photo</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                    </div>
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-md visible-lg">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Phones &amp; Accessories</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Phones &amp; Accessories</h5></a>
                        </div>
...
<!--            ends here-->
            ...
            <!--Ends here -->
             ...
             <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">TV, Video &amp; Audio</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">TV, Video &amp; Audio</h5></a>
                        </div>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Videogames</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Videogames</h5></a>
                        </div>
...
<!--            ends here-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="">
                                    <div class="row" id="boxvideogames">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
           ...
           <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Camera &amp; Photo</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Camera &amp; Photo</h5></a>
                        </div>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="misc.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Computers &amp; Tablets</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Computers &amp; Tablets</h5></a>
                        </div>
		...
		xmlhttp01.send();
           ...
           xmlhttp12.onreadystatechange = function(){
            ...
            $(document).ready(function(){
                ...
                sub_store('electronics','#boxphones',['phones','phonecables','adapters','cases','phoneaccessories','phoneparts','chargers','screen','watches','phonesothers']);
                sub_store('electronics','#boxtvvideo',['tvs','homespeakers','subwoofers','vr','homeaudio','portableaudio','tvaccessories','surveillance','gadgets','tvothers','wearables','software']);
                sub_store('electronics','#boxvideogames',['videogames','consoles','guides','videogameparts','videogametools','computerothers']);
                sub_store('electronics','#boxcamera',['camera','photoaccessories','drones','lenses','filters','frames','flashes','flashacc','photomanuals','cameralighting','studioequip','cameraparts','cameratools']);
                sub_store('electronics','#boxcomputers',['computercables','computerconnectors','computercomponents','tablets','computerparts','drives','networking','inputs','compaccessories','laptops','computersupplies','computeraccessories']);
