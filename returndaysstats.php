...
$monthselected = 12;
$yearselected = 2017;
$query = "SELECT * FROM `deliveries` WHERE YEAR(DATE(`date`)) = $yearselected AND MONTH(DATE(`date`)) = $monthselected AND DAY(DATE(`date`)) = $dayselected ORDER BY `date` ASC";
