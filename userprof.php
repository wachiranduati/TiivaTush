        ...
        <div class="container-fluid">
            <div class="row" style="background-color:rgba(0,0,0,0.2)">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <a href="index.php"><img src="editions/tiivi-logo.png" class="img-responsive" style="max-height: 50px;display: inline;" /></a>
               ...
               <div class="row visible-sm visible-xs" style="height:200px;background-image:url(editions/pexels-photo-11744.jpeg);background-size:cover;background-position:50%;margin-bottom:10%;">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="row" style="position:absolute;margin-top:37%;margin-bottom:2%;">
                           ...
                           <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="background-image:url(editions/manontop.jpeg);background-repeat:no-repeat;background-size:cover;background-position:50%;border-radius:50%;width:100px;height:100px;position: relative;bottom:80px;"></div>
                       </div>
                   </div>
                </div>
                    </div>
