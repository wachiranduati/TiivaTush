...
echo "
        <!doctype html>
<html>
    <title>Tiiva.co.ke | Mtumba | $search | $sub</title>
    <head>
...
<!-- end of advanced search container -->
            ...
            <div class=\"row visible-sm visible-xs\" style=\"margin-top:5px;\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\" style=\"border-bottom:2px solid orange;\">
                    <div class=\"row\">
                        <div class=\"col-lg-2 col-md-2 col-sm-12 col-xs-12\" style=\"border-bottom:1px solid white;background-color:black;margin-bottom:5px;\"><h4 class=\"text-center text-uppercase\" style=\"font-weight:bold;color:white;\"><a href=\"item.html\" style=\"color:white;\" class=\"btn-block\">$search | $sub</a></h4></div>
                    </div>
