...
<!DOCTYPE html>
<html>
<title>Tiiva | By Kenyan Designers &amp; Hobbyists</title>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 " style="border-top:1px solid gainsboro;">
                    ...
                    <div class="row visible-lg visible-md" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h2 class="text-center text-uppercase" style="margin-top:10px; color:orange;">By Kenyan Designers &amp; Hobbyists</h2></div>
                    </div>

                    <div class="row visible-sm visible-xs" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h4 class="text-center text-uppercase" style="margin-top:-1px; color:orange;">By Kenyan Designers &amp; Hobbyists</h4></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Fashion</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Artwork</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsdenimdesingerbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Other locally designed</a>
                            ...
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="icons/boxicon.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Home</a>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 visible-md visible-lg">
                        ...
                        <ul id="categories" style="line-height:2.5;padding-bottom:0;margin-bottom:2px;">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Fashion<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Artwork<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsdenimdesingerbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Other locally designed<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagstravelathleticbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Home<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsmiscpencilcase.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Beauty &amp; Grooming<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:1px solid gainsboro;">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Fashion</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Artwork</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Home</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Beauty &amp; Grooming</p></a></div>
                    </div>
                    ...
                    <div class="row visible-sm visible-xs" style="padding:7px;">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Fashion</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Artwork</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Home</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Beauty &amp; Grooming</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                    </div>
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-md visible-lg">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Fashion</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Fashion</h5></a>
                        </div>
...
<!--            ends here-->
            ...
            <!--Ends here -->
             ...
             <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Artwork</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Artwork</h5></a>
                        </div>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Other locally designed</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Other locally designed</h5></a>
                        </div>
...
<!--            ends here-->
           ...
           <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Beauty &amp; Grooming</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Beauty &amp; Grooming</h5></a>
                        </div>
...
<!--            ends here-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="">
                                    <div class="row" id="boxbeautygrooming">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="misc.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Home</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Home</h5></a>
                        </div>
		...
		xmlhttp01.send();
           ...
           xmlhttp12.onreadystatechange = function(){
            ...
            $(document).ready(function(){
                ...
                sub_store('handmade','#boxbath',['handmademensfashion','handmadewomensfashion','mensaccessories','womensaccessories','boyfashion','girlsfashion','handmadebabys']);
                sub_store('handmade','#boxartwork',['photographs','posters','paintings','drawings','artothers']);
                sub_store('handmade','#boxothers',['otheritems']);
                sub_store('handmade','#boxbeautygrooming',['skincare','handmadebath','fragrances','beautyproducts']);
                //sub_store('health','#boxwatches',['pocketwatches','watchwinders','wristwatchbands','wristwatches','watchothers']);
                sub_store('handmade','#boxhome',['homedecorlighting','pieces','handmadehomedecor','handmadekitchen','handmadefurniture']);
