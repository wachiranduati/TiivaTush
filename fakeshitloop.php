...
if($query_num_rows <= $notifymecount){
    ...
    <div class=\"row\" style=\"padding:4px;\">
            <a href=\"storeproduct.php?id=$query2_row[id]\" target=\"_blank\"><div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 productimage\" style=\"background-image:url('$query2_row[imageone]'); height:140px;width:100%;background-size:80%;\">
            ...
            <!--<div class=\"row\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                    <p class=\"text-center\">$query2_row[price] Ksh</p>
                </div>
            </div>
            <div class=\"row\">
                <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">
           ...
           <!-- <div class=\"row visible-lg visible-md\">
                ...
                <div class=\"col-lg-10 col-md-10 col-sm-10 col-xs-10\">
                    <a href=\"storeproduct.php?id=$query2_row[id]\" class=\"btn btn-block btn-primary\" data-name=\"$query2_row[itemtitle]\" data-price=\"$query2_row[price]\" target=\"_blank\">Add to Cart</a>
                </div>
                <div class=\"col-lg-1 col-md-1 col-sm-1 col-xs-1\"></div>
            </div>
            ...
            <div class=\"row visible-sm visible-xs\">
                ...
                <div class=\"col-lg-6 col-md-6 col-sm-6 col-xs-6\">
                    <a href=\"storeproduct.php?id=$id\" class=\"btn btn-sm btn-block btn-primary\" data-name=\"$query2_row[itemtitle]\" data-price=\"$query2_row[price]\" target=\"_blank\">Add to Cart</a>
                </div>
                <div class=\"col-lg-3 col-md-3 col-sm-3 col-xs-3\"></div>
            </div>-->
