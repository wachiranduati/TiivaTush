...
if($page == 1){
    $query = "SELECT * FROM `products` WHERE `subcategory`='".mysqli_real_escape_string($conn, $search)."' AND `sex`!='".mysqli_real_escape_string($conn, $sub)."' AND `availability`='1' AND `buyer`='0' LIMIT $items1";
}else{
    $query = "SELECT * FROM `products` WHERE `subcategory`='".mysqli_real_escape_string($conn, $search)."' AND `sex`!='".mysqli_real_escape_string($conn, $sub)."' AND `availability`='1' AND `buyer`='0' LIMIT $items OFFSET $jump";
}
...
$query2 = "SELECT * FROM `products` WHERE `subcategory`='".mysqli_real_escape_string($conn, $search)."' AND `sex`!='".mysqli_real_escape_string($conn, $sub)."' AND `availability`='1' AND `buyer`='0' ORDER BY RAND()";
