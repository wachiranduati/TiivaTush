...
<!DOCTYPE html>
<html>
<title>Tiiva | Beauty &amp; Health</title>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 " style="border-top:1px solid gainsboro;">
                    ...
                    <div class="row visible-lg visible-md" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h2 class="text-center text-uppercase" style="margin-top:10px; color:orange;">Beauty &amp; Health</h2></div>
                    </div>

                    <div class="row visible-sm visible-xs" style="margin-top:10px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home </a> / <a href="Electronics.php">Electronics</a><h4 class="text-center text-uppercase" style="margin-top:-1px; color:orange;">Beauty &amp; Health</h4></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Bath &amp; Body</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Hair &amp; Haircare</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsdenimdesingerbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Hand &amp; Feet care</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsclutchwristletbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Makeup</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="others/bagsslouchshopperbags.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Men's Grooming</a>
                            <a href="mainpage.php" target="_blank" class="list-group-item"><img src="icons/boxicon.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Perfumes</a>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 visible-md visible-lg">
                        ...
                        <ul id="categories" style="line-height:2.5;padding-bottom:0;margin-bottom:2px;">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsbackpack.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Bath &amp; Body<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsdenimbarrelbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Hair &amp; Haircare<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsdenimdesingerbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Hand &amp; Feet care<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsclutchwristletbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Makeup<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsslouchshopperbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Men's Grooming<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagstravelathleticbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Perfumes<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="others/bagsmiscpencilcase.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;Health<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:1px solid gainsboro;">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Bath &amp; Body</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Hair &amp; Haircare</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Perfumes</p></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs 3" style="height:25px;"><a href="mainpage.php" class="btn btn-block"><p class="text-uppercase text-center">Health</p></a></div>
                    </div>
                    ...
                    <div class="row visible-sm visible-xs" style="padding:7px;">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Bath &amp; Body</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Hair &amp; Haircare</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Perfumes</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-right:1px solid gainsboro;"><a href="mainpage.php">Health</a><a href="mainpage.php"><img class="img-responsive" src="images/cod.jpg"></a></div>
                    </div>
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-md visible-lg">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Bath &amp; Body</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Blackberry</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Injoo</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Infinix</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Motorolla</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Nokia</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Samsung</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Sony</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Htc</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Other labels</a>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Bath &amp; Body</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;samsung<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
            ...
            <!--Ends here -->
             ...
             <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Hair &amp; Haircare</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Hair &amp; Haircare</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;tcl<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Hand &amp; Feet care</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Hand &amp; Feet care</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;macbook<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="">
                                    <div class="row" id="boxhandfeetcare">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">skincare</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Xbox</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Alienware</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Logic</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Nintendo</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Nvidia</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Playstation</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Razer</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Games</a>
                            <a href="mainpage.php" class="list-group-item"><img src="others/bagsclutch.gif" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Xbox</a>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">skincare</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/sportswearicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;xbox<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/mensicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;alienware<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/womens.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;logic<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/kidsicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;nintendo<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/householdicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;nvidia<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;playstation<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/shoesicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;razer<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/labelsgifticon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;activision<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/caps.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;other skincare labels<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div id="imagecarousel" class="carousel slide" data-interval="2000" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                    <img src="others/bagsclutchsaddlebags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>Asscreed</h3> -->
                            ...
                            <div class="item">
                                    <img src="others/bagsclutchpouchbags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>tom manenos</h3> -->
                                        <!-- <p>to be seen or not seen here</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsclutchwristletbags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsclutchclutchbags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Makeup</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Makeup</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;koko buy<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Men's Grooming</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Men's Grooming</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;kitchenwear<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="">
                                    <div class="row" id="boxmensgrooming">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
           ...
           <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Sunglasses</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Watches</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Toys</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Phone accessories</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Robotics</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Screw kits</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;computer accessories</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Power accessories</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Vehicle accessories</a>
                            <a href="mainpage.php" class="list-group-item"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Misc accessories</a>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="Mens.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Sunglasses</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/sportswearicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;watches<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/mensicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;toys<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/womens.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;phone accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/kidsicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;iot<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/householdicon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;screwkits<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;computer accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/shoesicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;power accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/labelsgifticon.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;vehicle accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            <li><a href="mainpage.php" target="_blank"><img src="icons/caps.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;misc accessories<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div id="imagecarousel" class="carousel slide" data-interval="2000" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                    <img src="others/bagsleatherbackpack.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>Asscreed</h3> -->
                            ...
                            <div class="item">
                                    <img src="others/bagsleatherdrawstringbags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>tom manenos</h3> -->
                                        <!-- <p>to be seen or not seen here</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsleathercrossbody.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsleatherpouch.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
...
<!--            ends here-->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="">
                                    <div class="row" id="boxsunglasses">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="height:200px; border:1px solid black;border-right:1px solid white;"><img src="images/spinner/spinner_large.gif" class="img-responsive loaderImage" style="position:absolute;top:20%;"/></div>
           ...
           <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="mainpage.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Health</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Health</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;beats<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="misc.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">Watches</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">Watches</h5></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php" target="_blank"><img src="icons/backpackicons.svg" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;trapeze bags<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div id="imagecarousel" class="carousel slide" data-interval="2000" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                    <img src="others/bagsmiscpencilcase.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>Asscreed</h3> -->
                            ...
                            <div class="item">
                                    <img src="others/bagsmiscnotebookbags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>tom manenos</h3> -->
                                        <!-- <p>to be seen or not seen here</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsmiscmakeupbag.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
                            ...
                            <div class="item">
                                    <img src="others/bagsmisctrapezebags.gif" class="img-responsive" style="height:398px;">
                                    <div class="carousel-caption">
                                        <!-- <h3>cod manenos</h3> -->
                                        <!-- <p>call of duty down in the dm</p> -->
                                    </div>
...
<!--            ends here-->
            ...
            <div class="row" style="">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row visible-lg visible-md">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00baff;font-family:kok;"><a class="btn btn-block" href="misc.php"><h4 class="text-uppercase" style="color:white;font-weight:bold;">perfumes</h4></a></div>
                    </div>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-10 col-xs-10" style="margin-top:5px;border:1px solid black; border-bottom:1px solid white;background-color:black;">
                            <a style="color:white;" href="mainpage.php" class="btn btn-block btn-sm"><h5 class="text-uppercase text-left" style="font-weight:bold;">perfumes</h5></a>
                        </div>
		...
		xmlhttp01.send();
           ...
           xmlhttp12.onreadystatechange = function(){
            ...
            $(document).ready(function(){
                ...
                sub_store('health','#boxbath',['showeprod','bodycare']);
                sub_store('health','#boxhaircare',['shampoo','hairtools','grooming','hairtreatment','hairextensions','haircare']);
                sub_store('health','#boxhandfeetcare',['undercures']);
                sub_store('health','#boxskincare',['male','female','both']);
                sub_store('health','#boxmakeup',['eyes','lips','face','beautytools','cosmeticbundles']);
                sub_store('health','#boxmensgrooming',['shaving','perfumes','moisturizer']);
                sub_store('health','#boxsunglasses',['men','women','unisex']);
                sub_store('health','#boxhealth',['health','oral','sexual','vitamins','suppliments','natural','homeopathic','vision']);
                sub_store('health','#boxwatches',['pocketwatches','watchwinders','wristwatchbands','wristwatches','watchothers']);
                sub_store('health','#boxperfumes',['menperf','womenperf','unisexperf','designerperf','bodyspray']);
