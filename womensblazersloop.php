...
$query = "SELECT * FROM `products` WHERE `subcategory`='$subcategory' AND `sex`!='male' AND `availability`='1' AND `buyer`='0'";
...
$query2 = "SELECT * FROM `products` WHERE `subcategory`='$subcategory' AND `sex`!='male' AND `availability`='1' AND `buyer`='0' ORDER BY RAND() LIMIT 6";
