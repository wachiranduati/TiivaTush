                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <a href="index.php"><span class="glyphicon glyphicon-home"></span> HOME </a>
                     <span class="glyphicon glyphicon glyphicon-chevron-right" style="color:gainsboro;"></span>
                      <a href="bag.php">BAGS</a><h2 class="text-center text-uppercase" style="margin-top:-10px; color:orange;">BAGS</h2>
                  </div>
            </div>
            ...
            <div class="row visible-sm visible-xs" style="margin-top:10px;margin-bottom:0;padding-bottom:0;font-family:kok;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0;">
                        <small><a href="index.php"> <span class="glyphicon glyphicon-home"></span> HOME </a>
                         <span class="glyphicon glyphicon glyphicon-chevron-right" style="color:gainsboro;"></span>
                          <a href="bag.php">BAGS</a></small>
                          <h4 class="text-center text-uppercase" style="margin-top:5px; color:orange;">BAGS</h4>
                  </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 visible-md visible-lg">
                        ...
                        <ul id="categories" style="line-height:2.5;padding-bottom:0;margin-bottom:2px;">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=slouch&page=1" target="_blank"><img src="others/bagsslouchshopperbags.gif" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;shoulder Bags<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                        ...
                        <ul class="dropdown-menu list-group">
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;DayPacks</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Heritage Bpks</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Rucksacks</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Everlane snps</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Spade Wxwr</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;BackPacks</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;GoRucks</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;ScoutSeries</a>
                            <a href="mainpage.php?search=bags&sub=backpack&page=1" class="list-group-item"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/>&nbsp;&nbsp;Misc Backpks</a>
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=backpack&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;gorucks<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=duffel&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;bucket bags<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=clutch&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;saddle<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=slouch&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;satchel bags<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=bags&sub=misc&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;trapeze bags<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpagee.php?search=bags&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;madewell<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
