                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <a href="index.php"><span class="glyphicon glyphicon-home"></span> HOME </a>
                     <span class="glyphicon glyphicon glyphicon-chevron-right" style="color:gainsboro;"></span>
                      <a href="shoes.php">SHOES</a><h2 class="text-center text-uppercase" style="margin-top:-10px; color:orange;">SHOES</h2>
                  </div>
            </div>
            ...
            <div class="row visible-sm visible-xs" style="margin-top:10px;margin-bottom:0;padding-bottom:0;font-family:kok;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0;">
                        <small><a href="index.php"> <span class="glyphicon glyphicon-home"></span> HOME </a>
                         <span class="glyphicon glyphicon glyphicon-chevron-right" style="color:gainsboro;"></span>
                          <a href="shoes.php">SHOES</a></small>
                          <h4 class="text-center text-uppercase" style="margin-top:5px; color:orange;">SHOES</h4>
                  </div>
            </div>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=sports&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;under-armour<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=flats&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;loafers<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=toms&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;desert boot<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=boots&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;over the knee boots<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=sandals&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;birkenstock sandals<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=loafers&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;single-monk strap<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=vans&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;jack purcell<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=rubber&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;quarters<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpage.php?search=shoes&sub=misc&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;dress boots<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
...
<!--                                <span class="caret"></span>-->
                    ...
                    <div class="row">
                        ...
                        <ul id="categories">
                            ...
                            <li><a href="mainpagee.php?search=shoes&page=1" target="_blank"><img src="icons/backpackicons.png" class="img-responsive" style="height:25px;display:inline;"/><span class="text-uppercase">&nbsp;&nbsp;reebok<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top:7%;"></span></span></a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 visible-lg visible-md"><h4>About shopper</h4>
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a style="color:black;" href="Howto.php">Copyright</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
