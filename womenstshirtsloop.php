...
$query = "SELECT * FROM `products` WHERE `sex`!='men' AND `subcategory`='$subcategory' AND `availability`='1' AND `buyer`='0'";
...
$query2 = "SELECT * FROM `products` WHERE `sex`!='men' AND `subcategory`='$subcategory' AND `availability`='1' AND `buyer`='0' ORDER BY RAND() LIMIT 6";
